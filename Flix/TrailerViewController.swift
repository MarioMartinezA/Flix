...
//  Flix
//
//  Created by Mario Martinez on 2/7/18.
...
class TrailerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let movie = movie {
            ...
            let idNum = movie[ResultsKeys.id] as! Int
            self.id = String(idNum)
            print(id)

        }
       /*
        let url = "https://www.youtube.com/watch?v=p-yIGS9eW-o"
    ...
    func fetchMovies() {
        ...
        let task = session.dataTask(with: request) { (data, response, error) in
            ...
            if let error = error {
                ...
                let key = officialTrailer[ResultsKeys.key] as! String
